...
public class Human extends MiddleEarthCharacter {
	/**
	 * 
	 * This method will construct a new Human subclass with default values.
	 * 
	 */
	public Human() {
		this.name = "Unknown";
	...
	/**
	 * This method will construct a new Human subclass with provided values.
	 * @param n 
	...
	public boolean attack(MiddleEarthCharacter target) {
		...
		if((target.getRace() != this.getRace()) && (target.getRace() != "Orc")){
